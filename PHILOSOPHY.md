...
## North Star
Advance interpath through small, testable changes aligned to its core mission: Product artifact generator — roadmaps, PRDs, vision docs, changelogs, and status reports from beads, brainstorms, and project state. Companion plugin for Clavain.
