...
Product artifact generator — 1 skill, 8 commands, 0 agents, 0 hooks, 0 MCP servers. Companion plugin for Clavain. Generates roadmaps, PRDs, vision docs, changelogs, CUJs, and status reports from beads state, brainstorms, and project context.
