"""Tests for Interpath skill structure."""
...
def test_artifact_gen_references_exist(skills_dir):
    """artifact-gen skill has reference files."""
    refs_dir = skills_dir / "artifact-gen" / "references"
    expected = ["source-catalog.md", "output-templates.md"]
    for name in expected:
